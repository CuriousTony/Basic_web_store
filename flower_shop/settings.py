...
SECRET_KEY = 'django-insecure-u40wrq=^vvk%!=_n7fipcaa7-0s(gc*2&ib8&@l)gs+5fa7nmk'
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # папка для загрузки изображений
MEDIA_URL = '/media/'  # URL для доступа к медиа-файлам
os.environ["DJANGO_ALLOW_ASYNC_UNSAFE"] = "true"  # для работы с асинхронными сигналами
